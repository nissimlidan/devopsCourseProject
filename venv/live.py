...
def load_game():
    ...
    print(COLOR_CYAN + '[1]. Memory Game '+ COLOR_RESET + '- a sequence of numbers will appear for 1 second and you have to guess it back' + COLOR_RESET)
    print(COLOR_GREEN + '[2]. Guess Game '+ COLOR_RESET + '- guess a number and see if you chose like the computer')
    print(COLOR_BLUE + '[3]. Currency Roulette '+ COLOR_RESET + '- try and guess the value of a random amount of USD in ILS' + COLOR_RESET)
